  ...
  <a-card :bordered="false">
    <a-spin :spinning="loading">
      <a-form
        ...
        :wrapper-col="{ span: 18 }"
      >
        <a-form-item label="仓单运营平台编号">
          {{ platformNumber }}
          <input hidden v-decorator="platformId" />
        </a-form-item>
...
import { editPlatform, toEditPlatform } from 'api/platform';
    ...
    async getData() {
      try {
        ...
        const {
          ...
          platformNumber,
          companyOrgCode,
        } = await toEditPlatform({ platformId });
